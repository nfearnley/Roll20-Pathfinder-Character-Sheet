...
var columnBuffMods = [ "-total", "-total_penalty"];
var columnModHelpers = [ "condition-Helpless", "condition-Paralyzed"];
/**
...
/**
 * Returns the number and mod for an ability
...
export function updateAbilityScore(ability, eventInfo, callback, silently) {
    ...
    var fields = getAttributes(ability);
    getAttrs(fields, function(v) {
        var params = {};
        var setter = {};
...
export function recalculate(callback, silently, oldversion) {
    ...
    var updateDependentAttrs = _.once(function() {
        propagateAbilityModsAsync(done, silently);
    });
    var updateScoresOnce = _.once(function() {
