...
var optionToggles = ["toggle_attack_melee_notes", "toggle_attack_ranged_notes", "toggle_attack_CMB_notes", "toggle_attack_attack_notes", "toggle_attack_header_image"];
var repeatingOptionAttrs = ["attack-type", "damage-ability", "damage-dice-num", "damage-die", "damage", "attack"];
var repeatingOptionHelperAttrs = [""];
var repeatingOptionGetAttrs = repeatingOptionAttrs.concat(repeatingOptionHelperAttrs);
var repeatingOptionGetAttrsLU = _.map(repeatingOptionGetAttrs, function(field) {
    return "_" + field;
});
var events = {
...
/**
 * Resets entire macro options text for a repeating_weapon row
...
function getOptionText(prefix, toggleValues, rowValues) {
    ...
    var damageAbility = PFUtils.findAbilityInString(rowValues[prefix + "damage-ability"]);
    var optionText = "{{buff_note=@{buff_attack_notes}}} {{condition_note=@{condition_attack_notes}}}";
...
export function resetOption(id, eventInfo, callback) {
    ...
    var rowfields = _.map(repeatingOptionGetAttrs, function(attr) {
        return prefix + attr;
    });
    var allFields = optionToggles;
