...
function recalculateRepeatingMaxUsed(section, callback, silently) {
    ...
    getAttrs(["is_newsheet"], function(vout) {
        ...
        getSectionIDs("repeating_" + section, function(ids) {
            ...
            var rowdone = _.after(totrows, done);
            if (totrows > 0) {
...
function setNewDefaults(callback, section) {
    ...
    var sectionToDefaultRuleCategoryMap = {
        "feat": "feats",
        "trait": "traits",
    ...
    var defaultabilitytype;
    var defaultrulecategory;
    var defaultshow;
...
export function migrate(callback, oldversion) {
    ...
    var numLists = _.size(featureLists);
    var doneOne = _.after(numLists, done);
...
function registerEventHandlers() {
    ...
    _.each(featureLists, function(section) {
        ...
        var singleEvent = "change:repeating_" + section + ":";
