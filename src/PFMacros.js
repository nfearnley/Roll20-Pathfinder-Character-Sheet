...
export function checkBaseAttacks() {
    getAttrs(["Melee-Attack-macro", "Melee2-Attack-macro", "Ranged-Attack-macro", "Ranged2-Attack-macro", "CMB-Check-macro", "CMB2-Check-macro"], function(values) {
        ...
        var macroTextMelee2 = values["Melee2-Attack-macro"];
        var macroTextRanged = values["Ranged-Attack-macro"];
        var macroTextRanged2 = values["Ranged2-Attack-macro"];
        var macroTextCMB = values["CMB-Check-macro"];
        var macroTextCMB2 = values["CMB2-Check-macro"];
