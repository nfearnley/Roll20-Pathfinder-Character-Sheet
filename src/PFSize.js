...
export function getSizeLevelChange(currSize, defaultSize) {
    var newSize = sizeModToEasySizeMap[String(currSize)];
    var oldSize = sizeModToEasySizeMap[String(defaultSize)];
    var levelChange = newSize - oldSize;
    return levelChange;
}
...
export function updateDamageDice(sizediff, defaultSize, currDice, currDie) {
    ...
    var currow = 0;
    var newrow = 0;
    var reversedDiceSizes = _.reduce(diceSizes, function(memo, pairs, idx) {
        ...
        try {
            ...
            if (eventInfo && eventInfo.sourceAttribute === "buff_size-total") {
                ...
                if (levelChange === 0) {
                    ...
                    if (levelChange === 0 &&
                        eventInfo &&
                        ((parseInt(eventInfo.previousValue, 10) || 0) !== (parseInt(eventInfo.newValue, 10) || 0))) {
...
export function recalculate(callback, silently) {
